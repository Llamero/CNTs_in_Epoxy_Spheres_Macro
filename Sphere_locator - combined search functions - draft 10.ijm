...
//THe factor is how much tolerace there is for a sphere to be outside the image during hte cap search (1 = no tolerance, >1 = increasing tolerance);
SphereOutsideFactor = 
